...
<div class="row">
    ...
    <div class="col-md-6 col-lg-4 mb-4">
        <div class="card card-hover h-100">
            ...
            <img src="{{ Storage::url($documentation->featured_image) }}" class="card-img-top" 
                 alt="{{ $documentation->title }}" style="height: 200px; object-fit: cover;">
            @else
            ...
            <div class="card-body">
                ...
                <p class="card-text text-muted small">{{ Str::limit($documentation->summary, 100) }}</p>
                ...
                <div class="mb-2">
                    ...
                    <small>Oleh: {{ $documentation->creator->name }}</small>
                </div>
                <div class="mb-3">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <small class="text-muted">
                        {{ $documentation->published_at->format('d M Y') }}
                    </small>
