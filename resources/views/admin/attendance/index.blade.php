                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ \App\Models\AttendanceLog::whereDate('check_in_time', today())->count() }}
                        </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                            Konfirmasi Hadir</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ \App\Models\AttendanceConfirmation::hadir()->count() }}
                        </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                            Kehadiran Diverifikasi</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ \App\Models\AttendanceLog::where('is_verified', true)->count() }}
                        </div>
                    </div>
                    <div class="col-auto">
